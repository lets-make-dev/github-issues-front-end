                        ...
                        <div class="bg-white dark:bg-gray-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <h3 class="text-lg leading-6 font-medium dark:text-white text-gray-900" id="modal-headline">
                                        Create New Project
                                    </h3>
                                    <div class="mt-2">
                                        <div>
                                            <label for="newProjectName" class="block text-sm font-medium dark:text-white text-gray-700 mb-2">Project Name</label>
                                            <input type="text" id="newProjectName" wire:model.defer="newProjectName" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-900">
