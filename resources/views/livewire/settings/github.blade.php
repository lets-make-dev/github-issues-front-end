<div>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center space-x-4">
            <select x-model="selectedAccount" @change="repositories = []" class="flex-1 px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-800">
    ...
    <div x-show="selectedAccount && repositories.length > 0" class="mb-6">
        ...
        <select class="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-800">
