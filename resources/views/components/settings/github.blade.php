...
<div x-data="{
        ...
        repoOpen: false,
        selectedRepo: null,
        selectedAccountId: @entangle('selectedAccount')
    }">
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                <button @click="open = !open" type="button"
                    ...
                    <span class="block truncate" x-text="selectedAccountId ? githubAccounts[selectedAccountId] : 'Select a GitHub account'"></span>
                ...
                <div x-show="open" @click.away="open = false"
                    ...
                    <ul tabindex="-1" role="listbox" aria-labelledby="listbox-label"
                        ...
                        <template x-for="(name, id) in githubAccounts" :key="id">
                            <li @click="selectedAccountId = id; open = false; $wire.accountSelected(id)"
